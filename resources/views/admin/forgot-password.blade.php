...
<head>
    ...
    <meta charset="utf-8" />
    <title>Adnub - Forgot Password </title>
...
{{-- #01487E --}}
                    <div class="text-center mt-3">
                        <div class="mb-2">
                            <a href="{{ url('admin/forgot-password') }}" class="auth-logo">
                    ...
                    <div class="p-3 pt-1">
                        <form method="POST" action="{{ route('admin_forgot_password_submit') }}"
                            ...
                            <div class="form-group mb-3 text-center row mt-3 pt-1">
                                <div class="col-12">
                                    <button class="btn btn-dark w-100 waves-effect waves-light" type="submit">Email
                            ...
                            <div class="form-group mb-0 row mt-2">
                                <div class="col-sm-5 mt-3">
                                    <a href="{{ route('admin_login') }}" class="text-muted"><i
                                            class="mdi mdi-account-circle"></i> Back to login</a>
                                </div>
                            </div>
                        </form>
                    </div>

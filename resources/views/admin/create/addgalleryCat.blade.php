...
@section('admin')
    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="card">
                <h5 class="card-header">Add Gallery Category</h5>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <form method="post" action="{{ route("store.galleryCat") }}" enctype="multipart/form-data">
                                @csrf
                            ...
                            <div class="row mb-3 mt-4">
                                ...
                                <div class="col-sm-10">
                                    <input name="gallery_category" class="form-control" type="text"  id="gallery_category">

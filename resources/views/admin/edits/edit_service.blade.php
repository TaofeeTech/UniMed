    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <h5 class="card-header text-uppercase">Edit Service </h5>
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update_service') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-lg"
                                            src="{{ !empty($service->image) ? url($service->image) : url('upload/no_image.png') }}"
                                            alt="{{ $service->image }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3 mt-4">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="description" class="form-control" id="editor" cols="30" rows="10">{{ $service->description }}</textarea>
                                        @error('description')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <input type="submit" class="btn btn-primary waves-effect waves-light" value="Update Service">
                            </form>
